...
<div class="form-group">
    ...
    <div class="form-group">
        <label for="image" class="col-sm-2 control-label">@lang('planet.comment')</label>
        <div class="col-sm-5">
@if ($planet)
@if ($planet-> image)
   <img src="/image/uploads/{{$planet->image}}" style="max-width: 100px; margin-bottom: 15px; "
        class="img-rounded">
@endif
{{Form::file('image', array('class'=>'form-control','style'))}}<br />
   @else{{Form::file('image', array('class'=>'form-control'))}}<br />
@endif
